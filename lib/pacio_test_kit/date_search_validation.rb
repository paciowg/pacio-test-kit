module PacioTestKit
  module DateSearchValidation
    ...
    def get_fhir_period_range(period) # rubocop:disable Metrics/AbcSize
    ...
    def fhir_date_comparer(search_range, target_range, comparator, extend_start = false, extend_end = false) # rubocop:disable Metrics/AbcSize,Metrics/CyclomaticComplexity,Metrics/MethodLength,Style/OptionalBooleanParameter
      # Implicitly, a missing lower boundary is "less than" any actual date. A missing upper boundary is
    ...
    def is_date?(value) # rubocop:disable Naming/PredicateName
