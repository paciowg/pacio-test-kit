...
require_relative 'document_reference/documentref_id_search_test'
require_relative 'document_reference/documentref_custodian_search_test'
require_relative 'document_reference/documentref_date_search_test'
require_relative '../common_tests/identifier_search_test'
require_relative '../common_tests/patient_search_test'
require_relative 'document_reference/documentref_period_search_test'
require_relative 'document_reference/documentref_status_search_test'
require_relative 'document_reference/documentref_type_search_test'
