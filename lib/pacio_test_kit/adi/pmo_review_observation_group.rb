...
module PacioTestKit
  module ADI
    class PMOReviewObservationGroup < Inferno::TestGroup
      ...
      The PACIO ADI PMO Review Observation Profile tests verify that the system under test is able to provide
      correct responses for Observation queries. These queries must contain resources conforming to the
      PMO Review Observation Profile as specified in the PACIO Advance Directive Interoperability (ADI) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the PMO Review Observation Profile. Each
      ...
      test from: :pacio_resource_validation,
           title: 'Observation Resources returned in previous tests conform to the ADIPMOReviewObservation profile',
