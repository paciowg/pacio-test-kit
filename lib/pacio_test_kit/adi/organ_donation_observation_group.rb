...
module PacioTestKit
  module ADI
    class OrganDonationObservationGroup < Inferno::TestGroup
      ...
      The PACIO ADI Organ Donation Observation Profile tests verify that the system under test is able to provide
      correct responses for Observation queries. These queries must contain resources conforming to the
      Organ Donation Observation Profile as specified in the PACIO Advance Directive Interoperability (ADI) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the Organ Donation Observation Profile. Each
      ...
      test from: :pacio_resource_validation,
           title: 'Observation Resources returned in previous tests conform to the ADIOrganDonationObservation profile',
