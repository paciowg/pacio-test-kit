...
module PacioTestKit
  module ADI
    class PACPCompositionGroup < Inferno::TestGroup
      ...
      The PACIO ADI PACP Composition Profile tests verify that the system under test is able to provide
      correct responses for Composition queries. These queries must contain resources conforming to the
      PACP Composition Profile as specified in the PACIO Advance Directive Interoperability (ADI) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the PACP Composition Profile. Each
