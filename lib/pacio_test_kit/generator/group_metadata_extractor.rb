    ...
    class GroupMetadataExtractor
      ...
      def class_name
        base_name
          ...
          .map(&:capitalize)
          .join
          .gsub('PFE', "PFE#{ig_metadata.reformatted_version}")
          .concat('Sequence')
      end
      ...
      def include_params
        resource_capabilities.searchInclude || [] # TODO
      end

      def revincludes
        resource_capabilities.searchRevInclude || [] # TODO
      end
      ...
      def must_supports
        return if profile.nil? # added for now
