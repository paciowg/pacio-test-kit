...
module PacioTestKit
  module PFE
    class DiagnosticReportNoteExchangeGroup < Inferno::TestGroup
      ...
      The PACIO PFE Diagnostic Report Note Exchange Profile tests verify that the system under test is able to provide
      correct responses for DiagnosticReport queries. These queries must contain resources conforming to the
      Diagnostic Report Note Exchange Profile as specified in the PACIO Personal Functioning and Engagement (PFE) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the Diagnostic Report Note Exchange Profile.
