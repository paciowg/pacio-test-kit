...
module PacioTestKit
  module PFE
    class CollectionObservationGroup < Inferno::TestGroup
      ...
      The PACIO PFE Collection Observation Profile tests verify that the system under test is able to provide
      correct responses for Observation queries. These queries must contain resources conforming to the
      Observation Collection Profile as specified in the PACIO Personal Functioning and Engagement (PFE) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the Collection Observation Profile. Each
