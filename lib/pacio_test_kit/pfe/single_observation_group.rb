...
module PacioTestKit
  module PFE
    class SingleObservationGroup < Inferno::TestGroup
      ...
      The PACIO PFE Single Observation Profile tests verify that the system under test is able to provide
      correct responses for Observation queries. These queries must contain resources conforming to the
      Single Observation Profile as specified in the PACIO Personal Functioning and Engagement (PFE) IG
      ...
      ## Profile Validation
      Each resource returned from the first read is expected to conform to the Single Observation Profile. Each
