...
module PacioTestKit
  module PFEV200_BALLOT
    class PfeConditionEncounterDiagnosisMustSupportTest < Inferno::Test
      ...
      id :pfe_v200_ballot_pfe_condition_encounter_diagnosis_must_support_test
      ...
      def scratch_resources
        scratch[:pfe_condition_encounter_diagnosis_resources] ||= {}
      end
